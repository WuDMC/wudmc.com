...
class RouletteForm(forms.Form):
    searchTextField = forms.CharField(help_text='Place from where you wonna start your journey',label='Begin here', widget=forms.TextInput(attrs={'placeholder': 'Enter STARTPOINT loation' ,'autocomplete': 'on', 'runat': 'server', 'class': 'form-control'}), max_length=100)
